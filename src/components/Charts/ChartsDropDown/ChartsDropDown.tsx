            ...
            <Menu>
                {({ isOpen }) => (
                    <>
                        ...
                        <MenuList w="280px" minW="0" h="124px" mt={1.5} p="1px" py={0} bg="#161616" border="1px solid #494D51" borderRadius="6px" motionProps={{
                            transition: { duration: 0 },
                            animate: 'visible'}}>
                            <Flex direction='column' w='100%' h='100%' ml={2} py={0}>
                                <MenuItem w='86%' h='48px' mt={3} px={3} color='#A3A3A3' bg='none' borderRadius='6px' _hover={{cursor: 'pointer', bg: '#111111'}} onClick={() => addTimeseriesWidget()}>
                                ...
                                <MenuItem w='86%' h='48px' px={3} color='#A3A3A3' bg='none' borderRadius='6px' _hover={{cursor: 'pointer', bg: '#111111'}} onClick={() => addPieWidget()}>
