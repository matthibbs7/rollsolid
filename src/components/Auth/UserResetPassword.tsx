...
const UserResetPassword:React.FC = () => {
    ...
    return (
        <Flex justify="center" w="100%">
            <Flex align="center" direction="column" w={['100%', '90%', '80%', '60%']} maxW="500px" h="430px" mt={[1,1,5,5]} bg="#121212" border="1px solid black">
                <Flex align="center" direction="row" mt={8}>
                    <Text fontFamily="AvenirNext-DemiBold" fontSize={['24pt', '24pt', '28pt', '28pt']} fontWeight={700}>Reset Password&nbsp;</Text>
                ...
                <Flex direction="column" w={['90%', '90%', '65%', '65%']} mt={5} mr="auto" ml="auto">
                    <form onSubmit={onSubmit}>
                        ...
                        <InputGroup w="100%">
                            ...
                            <Input h="48px" mt={2} mb="17px" color="white" fontFamily="AvenirNext-DemiBold" bg="#282828" border="none" borderRadius="5px" _placeholder={{color: 'white', fontFamily: 'AvenirNext-DemiBold'}} focusBorderColor='black' name="email" onChange={onChange} placeholder="" required type="email" />
                        ...
                        <Text mt={2} fontFamily='AvenirNext-Regular' fontSize="10pt">Back to <Text as="span" fontFamily='AvenirNext-DemiBold' textDecoration="underline" _hover={{cursor: 'pointer'}} onClick={() => router.push('/login')}>login</Text></Text>
                        <Text mt={5} fontFamily='AvenirNext-Regular' fontSize="10pt" textAlign="center">New to Rollsolid? <Text as="span" fontFamily='AvenirNext-DemiBold' textDecoration="underline" _hover={{cursor: 'pointer'}} onClick={() => router.push('/signup')}>Sign Up</Text></Text>
                    </form>
                </Flex>
            </Flex>
        </Flex>
