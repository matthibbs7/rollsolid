        ...
        <Flex justifyContent="center" width="100%">
            <Flex bg="#121212" border="1px solid black" flexDir="column" mt={10} width={['90%', '80%', '80%', '60%']} maxWidth="540px" height="640px" align="center">
                <Flex align="center" mt={8} direction="row">
                    <Text fontSize="28pt" fontWeight={700} fontFamily="AvenirNext-DemiBold">Login to Rollsolid&nbsp;</Text>
                ...
                <Flex mt={10} ml="auto" mr="auto" width="65%" direction="column">
                    <form onSubmit={onSubmit}>
                        <Text fontWeight={600} fontFamily="AvenirNext-Regular">Username</Text>
                        
                        
                        
                        <Input required name="email" type="email" onChange={onChange} border="none" _placeholder={{color: 'white', fontFamily: 'AvenirNext-DemiBold'}} placeholder="" height="48px" focusBorderColor='black' fontFamily="AvenirNext-DemiBold" borderRadius="0" bg="#282828" mt={2} color="white" mb="17px" />
                            
                    
                        <Text fontWeight={600} fontFamily="AvenirNext-Regular">Password</Text>
                        
                            
                        <Input required name="password" onChange={onChange} _placeholder={{color: 'white', fontFamily: 'AvenirNext-DemiBold'}} placeholder="" height="48px" focusBorderColor='black' fontFamily="AvenirNext-DemiBold" border="none" borderRadius="0" mt={2} color="white" type="password" bg="#282828" />
