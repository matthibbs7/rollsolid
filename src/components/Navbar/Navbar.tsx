...
export const Navbar = () => {
    ...
    return (
        <Flex
            pos={router.pathname === '/about' ? 'fixed' : 'relative'}
            zIndex="1111111"
            align="center"
            direction="row"
            w="100%"
            ...
            px="15px"
            borderTop="1px solid"
            borderTopColor={router.pathname !== '/about' ? '#2F2F2F' : '#1D1D1D'}
            borderBottom="1px solid"
            borderBottomColor={router.pathname !== '/about' ? '#2F2F2F' : '#1D1D1D'}
            bgColor={cmb}
        >   
            <GiRollingBomb />
            ...
            {router.pathname === '/about' || router.pathname === '/login' || router.pathname === '/signup' || router.pathname === '/reset-password'  ? (
                <>
                    ...
                    <Button h="60%" ml={0} color='#A3A3A3' fontSize="11px" fontWeight={400} bg={cmb} border="1px solid #161616" borderRadius="0px" _hover={{border: '1px solid #494D51'}} _active={{border: '1px solid #494D51'}}><FaChartLine />&nbsp;&nbsp;<Text fontSize="12px">Features</Text></Button>
                    
                    <Button h="60%" ml={0} color='#A3A3A3' fontSize="11px" fontWeight={400} bg={cmb} border="1px solid #161616" borderRadius="0px" _hover={{border: '1px solid #494D51'}} _active={{border: '1px solid #494D51'}}><MdOutlineSupervisorAccount />&nbsp;&nbsp;<Text fontSize="12px">Support</Text></Button>
